...
namespace StandardCollections
{
    ...
    [Serializable, DebuggerTypeProxy(typeof(ReadOnlyCollectionProxy<>)), DebuggerDisplay("Count = {Count}")]
    public class ReadOnlySortedSet<T> : IReadOnlyList<T>, ISortedCollection<T>, ISet<T>, IIndexedSet<T>, ICommonSortedSet<T>, ICollection
    {
        ...
        [Serializable]
        internal class SubSetView : ReadOnlySortedSet<T>, ISerializable, IDeserializationCallback
        {
            ...
            public SubSetView(SerializationInfo info, StreamingContext context)
            {
                this._sinfo = info;
            }
