...
namespace StandardCollections
{
    ...
    [Serializable, DebuggerTypeProxy(typeof(EnumerableProxy<>)), DebuggerDisplay("Count = {Count}")]
    public class PriorityQueue<T> : IReadOnlyCollection<T>, IEnumerable<T>, ICollection, ICloneable
    {
